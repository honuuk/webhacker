...
${list}
    ...
    list: function(topics, result) {
        ...
        while (i < topics.length) {
            list = list + `<button class="dropdown-btn"> ${topics[i].topic} <i class="fa fa-caret-down"></i></button>
    <div class="dropdown-container" style="font-size:13px;">
        <ul class="navul">`;


            var content = 'Hello, WEBHACKER';
            var j = 0;
