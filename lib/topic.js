                                    ...
                                    .board_list:visited{
                                        ...
                                        <div id="id01" class="modal">
                                            ...
                                            <form class="modal-content animate" action="/create_process" method="post" autocomplete=off>
                                                ...
                                                <div class="container">
                                                    <label for="title"><b style="font-size:20px;">TITLE</b></label>
                                                    <input type="text" name="title" required style="height:30px; margin-left:10px;"> </br>

                                                    <label for="content"><b style="font-size:20px;">CONTENT</b></label><br />
                                        ...
                                        <div id="id02" class="modal" >
                                            ...
                                            <div class="modal-content animate" style="min-height:400px; color:black;" >
                                                ...
                                                <div class="container">
                                                    <label for="title"><b style="font-size:20px;">TITLE</b></label>
                                                    <div id="board_title" style="margin-bottom:10px;"></div>

                                                    <label for="content"><b style="font-size:20px;">CONTENT</b></label><br />
                                                    <div id="board_content" style="width:99%;height:200px;margin-top:10px;;"></div>
